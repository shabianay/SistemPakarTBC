    					...
    					<div class="col-md-4">
							...
							<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a>Penurunan berat badan</a></h3>
    							</div>
    						</div>
    					</div>
    				</div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">123123123</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
